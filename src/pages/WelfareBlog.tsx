...
const WelfareBlog = () => {
  ...
  const blogPost = {
    id: "4",
    title: "Empowering Communities: BEST’s Welfare Initiatives in Rural Pakistan",
    category: "Welfare",
    date: "January 31, 2009",
    image: "/images/Welfare.jpeg",
    readTime: "5 min read",
    content: String.raw`
The **Bashir Educational Scholarship Trust (BEST)** stands as a beacon of hope for rural Pakistan. Since 2004, our unwavering mission has been to uplift the lives of the underserved in **Chak No. 485 GB, Samundri, Faisalabad**. Guided by the heartfelt vision of **Bashir Ahmad Khan**, we are rewriting destinies through education, vocational empowerment, marriage support, and spiritual growth.

---

### 🌟 Educational Scholarships: Lighting the Path to Tomorrow

We believe **education is the most powerful investment in a child's future**. In 2004, BEST launched its scholarship program to empower talented but financially challenged students. The overwhelming response—**183 applications** in our first year—proved just how urgent this need was.

Through a merit-based process, we selected **20 students** who received PKR 1,000 monthly for three months. By late 2005, the number grew to **35 students**, and our ambitions soared to **40 scholarships** with a matching grant initiative.

📌 **Highlights:**
- 🏅 *December 2004:* Our first ceremony brought together families, educators, and community leaders.
- 🏅 *April 2005:* Continued scholarships awarded to 20 dedicated students.
- 🏅 *October 2005:* 35 students celebrated for their academic excellence.

By 2009, returns from National Investment Trust enabled us to expand support to **110 students**, proving how deeply-rooted commitment and wise investments change lives.

> “**Education is the key to empowerment.** Our scholarships break the chains of poverty and spark a brighter future,” — *Bashir Ahmad Khan, Chairman BEST*

---

### 💍 Marriage Support: Honoring Traditions, Supporting Dreams

In rural communities, marrying daughters is a joyful yet financially burdensome event. BEST steps in to **ease the load on struggling families**, supporting over **20 marriages** to date. This compassionate initiative brings dignity and peace of mind to parents who wish the best for their daughters—without financial fear holding them back.

---

### 🧵 Women’s Vocational Training: Stitching Together New Opportunities

Empower a woman, and you empower a household. That’s why we launched a **vocational training program** with humble beginnings—**8 simple sewing machines, 1 digital machine**, and the dreams of 20 courageous women.

Due to overwhelming interest, we now train **35+ women** in tailoring skills, guided by professional instructors. These women are not just learning to sew—they’re **weaving their independence**, one stitch at a time.

To maintain quality and personalized guidance, we plan to **limit future batches to 20 students**—ensuring deep, lasting impact.

---

### 🕌 Religious Education: Nourishing Hearts and Souls

Our approach to welfare is holistic. Beyond physical and financial needs, we also nurture the **spiritual wellbeing** of our community.

We built a **beautiful mosque** in Village No. 485 G.B., where **150–200 students** gather daily. Mornings are devoted to Quran recitation, evenings to Hadith classes. Led by a **Qari and a scholar from Medina University**, this sacred space blossoms with knowledge and reverence.

Despite modest staff salaries (PKR 10,000/month), the spiritual return is **immeasurable**.

---

### 🤝 Community Trust and Challenges

Our work is embraced by the community with open arms—but their resources are limited. Local residents have given what they can. Now, **we seek your support** to sustain and grow these impactful programs.

We continue to reinvest in the **National Investment Trust** to create sustainable funding. But real transformation demands **collective effort**.

---

### 🚀 The Road Ahead: A Shared Journey of Impact

Together, we can:
- Expand scholarship access to **even more students**.
- Help **more families** celebrate joyful weddings with dignity.
- Train **more women** to become financially independent.
- Deepen **religious education** for future generations.

**Will you walk with us?**

Your generosity has the power to transform entire communities.  
Let’s build a future where **every child learns**, every **family thrives**, and every **soul shines bright**.

---

**💖 Join hands with BEST. Invest in lives. Leave a legacy.**
`,
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  {
                    icon: Users,
                    title: "110 Scholarships",
                    desc: "Awarded to students by 2009",
                  },
                  {
                    icon: Heart,
                    title: "20+ Marriages",
                    desc: "Supported for rural families",
                  },
                  {
                    icon: Users,
                    title: "35 Women Trained",
                    desc: "In vocational sewing skills",
                  },
                  {
                    icon: Heart,
                    title: "150–200 Students",
                    desc: "Engaged in religious education",
                  },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
