        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Providing essential nutritional support to families in need
              through our dahej distribution program.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-foundation-gray-700 mb-4">
                Dahej is a traditional form of support providing essential dairy
                products to families in need. Our program ensures that
                nutritious milk and dairy products reach those who need them
                most, particularly focusing on children and pregnant mothers.
              </p>
              <p className="text-foundation-gray-700 mb-6">
                Through our extensive network of volunteers and partners, we
                distribute fresh dairy products weekly to registered families,
                ensuring consistent nutritional support for growing children and
                supporting family health.
              </p>
              <div className="bg-foundation-green/10 border-l-4 border-foundation-green p-4 rounded">
                <p className="text-foundation-green font-semibold">
                  Impact This Month:
                </p>
                <p className="text-foundation-gray-700">
                  642 families received regular dahej support, benefiting over
                  2,500 individuals including 800+ children.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-foundation-gray-600">
              A systematic approach to providing nutritional support
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-lg bg-foundation-gray-50">
              ...
              <p className="text-foundation-gray-600">
                We identify and register families in need through community
            ...
            <div className="text-center p-6 rounded-lg bg-foundation-gray-50">
              ...
              <p className="text-foundation-gray-600">
                We source fresh, high-quality dairy products from trusted local
                suppliers.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg bg-foundation-gray-50">
              ...
              <p className="text-foundation-gray-600">
                Weekly distribution ensures consistent nutritional support for
